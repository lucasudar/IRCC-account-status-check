...
import time
from config import username_token, password_token, question_one, answer_one, question_two, answer_two, question_three, answer_three, question_four, answer_four
